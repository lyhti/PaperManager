...
<head>
    <script type="text/javascript" src="{{ asset('juso_support_center/assets/js/jquery-1.12.4.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('juso_support_center/assets/js/rnic-search.js') }}"></script>
    <script type="text/javascript" src="{{ asset('juso_support_center/assets/js/rnic-common.js') }}"></script>

    <link rel="stylesheet" type="text/css" href="{{ asset('juso_support_center/assets/css/addrlink/common.css') }}"/>
    <link rel="stylesheet" type="text/css" href="{{ asset('juso_support_center/assets/css/addrlink/addrlink.css') }}"/>
    ...
    <script type="text/javascript">
        ...
        function searchUrlJuso(){
            ...
            if( "Y" == "null" ){
                ...
                $("#AKCFrm").attr("action","https://business.juso.go.kr/addrlink/addrLinkUrlSearch.do").submit();
            }
        }
                    ...
                    if( resultType == "1" ){
                        ...
                        if($(this).find('relJibun').text() != ''){
                            ...
                            if($(this).find('relJibun').text().length()<100){
                                ...
                                htmlStr +='<span id="label_relJibun_'+num+'}">'+$(this).find('relJibun').text().substring(0,80)+'...</span><a href="#this" class="info-more" onclick="javascript:fullText(\'label_relJibun_'+num+'\',\''+$(this).find('relJibun').text()+'\');">더보기</a>';
                            }
                            htmlStr +='		</div>';
                        }
        ...
        function setMaping(idx){
            ...
            if( "Y" == "" ){
                ...
                $.ajax({
                    ...
                    ,type:"post"
                    ,data:{ "confmKey": "U01TX0FVVEgyMDIyMTEzMDE2MjIzNDExMzI3NDY=", "admCd": admCd, "rnMgtSn": rnMgtSn, "udrtYn": udrtYn, "buldMnnm": buldMnnm, "buldSlno": buldSlno, "searchType": "dong", "resultType": "json" }
                    ,dataType:"json"
        ...
        function getDetailAddrFloor(val){
            ...
            $.ajax({
                url :"/addrlink/addrDetailApi.do"
                ,type:"post"
                ,data:{ "confmKey": "U01TX0FVVEgyMDIyMTEzMDE2MjIzNDExMzI3NDY=", "admCd": $("#rtAdmCd").val(), "rnMgtSn": $("#rtRnMgtSn").val(), "udrtYn": $("#rtUdrtYn").val(), "buldMnnm": $("#rtBuldMnnm").val(), "buldSlno": $("#rtBuldSlno").val(), "searchType": "floorho", "dongNm": val, "resultType": "json" }
                ,dataType:"json"
                ,success:function(data){
                    if(data.results != undefined){
        ...
        $(function(){
            ...
            //우선정렬 라디오 클릭
            $("input:radio[name=raFirstSort]").click(function(){
...
<form name="AKCFrm" id="AKCFrm" method="post">
    ...
    <input type="hidden" name="reqstUrl"   value="" />
    <input type="hidden" name="confmKey" value="U01TX0FVVEgyMDIyMTEzMDE4MDQwMzExMzI3NTM=" />
    ...
    <input type="hidden" name ="addInfoYn"     id="addInfoYn" 	value="Y" />
    <!-- 추가된 항목(hstryYn, relJibun, hemdNm) 제공여부 -->
                ...
                <div class="detail" style="display:none;" id="resultData">
                    ...
                    <table class="data-row">
                        ...
                        <tr>
                            ...
                            <td id="addrPart1"
                                style="font-size:15px; height:20px; line-height:20px; background-color: #FFFFFF; padding: 10px 20px;">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="background-color: #FFFFFF;padding: 10px 20px;">
                                ...
                                <div id="addrPartDetailNoneGuide"
                                     style="font-size: 11px;visibility: hidden;margin-top: 8px;">
