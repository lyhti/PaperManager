...
<<<<<<< HEAD
        ...
        <div class="float-clear pdf-chck-height">
            <div class="float-left dist-top-mm-5 wd-mm-172">
                <div class="dist-btm-mm-3">
                    <span>공 사 명 :&nbsp;&nbsp;</span>
                    <span>
                        <input type="text" class="border-line wd-mm-151_1" name="cstrn_nm"/>
                    </span>
                </div>
                <div class="dist-btm-mm-3">
                    <span>변전소 및 기기명 :&nbsp;&nbsp;</span>
                    <span>
                        <input type="text" class="border-line wd-mm-36" name="sub_sttn_nm"/>
                    </span>
                    <span>S/S</span>
                    <span>
                ...
                <div class="dist-btm-mm-3">
                    ...
                    <span>&nbsp;&nbsp;날씨 :</span>
                    <span>
                        <input type="text" class="align-center border-line wd-mm-20 display-none" name="weather" value="맑음"/>
                    </span>
                    <span>
                    ...
                    <span>&nbsp;&nbsp;기온 :</span>
                    <span>
                        <input type="text" class="border-line align-right wd-mm-9_5" name="tmpt" maxlength="4"/>
                    </span>
                    <span>℃</span>
                    <span>&nbsp;&nbsp;습도 :</span>
                    <span>
                        <input type="text" class="border-line align-right wd-mm-9_5" name="hmdt" maxlength="4"/>
                    </span>
                    <span>%</span>
                </div>
                <div class="dist-btm-mm-3">
                    ...
                    <span class="sign-modal dist-left-mm-5" onclick="openModal('chck')">(인)</span>
                    <span class="tooltip-custom2">
                    ...
                    <span class="dist-left-mm-33">감 독 자 :</span>
                    <span>
                        <input type="text" class="border-line align-center wd-mm-25" name="spvs_nm"/>
                    </span>
                    <span class="sign-modal dist-left-mm-5" onclick="openModal('spvs')">(인)</span>
                    <span class="tooltip-custom2">
                        <span class="tooltip-custom-text2">
                            "(인)" 클릭 시,
                            <br/>
        ...
        <div class="pdf-chck-height">
            <table class="table-bd wd-per-100">
                ...
                <tr>
                    ...
                    <td class="align-center">
                        <input type="text" class="border-line" name="prdc_ym"/>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="align-center">
        <button type="button" id="updateBtn" class="me-5 btn btn-primary btn-l" onclick="updateDoc()">수    정</button>
...
>>>>>>> 1061ba8a9dfbe33fa052044d6657d71e405fb1b9
...
<<<<<<< HEAD
        ...
        function openModal(data) {
            ...
            if (!document.getElementById(canvasId)) {
                $('#' + data).append('<canvas id="' + canvasId + '" width="1060" height="550"></canvas>');
            }
...
<<<<<<< HEAD
        ...
        function updateDoc() {
            $('input[type=text], input[type=date]').removeClass('border-none');
...
<<<<<<< HEAD
                    ...
                    // txtArea.forEach(function(data) {
                    //     // html2canvas 사용 시, textarea 개행 불가로 인한 임시 태그 변경
                    //     data.outerHTML = data.outerHTML.replaceAll('pre', 'textarea');
                    // });
